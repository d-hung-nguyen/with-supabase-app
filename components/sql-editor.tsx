...
export function SqlEditor({
  ...
  const isReadOnlyError =
    serverErrorMessage.includes("permission denied") ||
    serverErrorMessage.includes("42501")
  const customReadOnlyError =
    "You can't directly alter your database schema, use chat instead"
