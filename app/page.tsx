          ...
          <div className="glass-card p-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="glass-card p-3">
                  <div className="font-medium emerald-accent mb-1">agents</div>
                  <div className="text-xs text-muted-foreground space-y-0.5">
                ...
                <div className="glass-card p-3">
                  <div className="font-medium emerald-accent mb-1">hotels</div>
                  <div className="text-xs text-muted-foreground space-y-0.5">
              ...
              <div className="space-y-3">
                ...
                <div className="glass-card p-3">
                  <div className="font-medium emerald-accent mb-1">rewards</div>
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    <div>• id, user_id</div>
                ...
                <div className="glass-card p-3">
                  <div className="font-medium emerald-accent mb-1">regions</div>
                  <div className="text-xs text-muted-foreground space-y-0.5">
                    <div>• id, name</div>
                    <div>• created_at, updated_at</div>
                  </div>
            ...
            <div className="mt-4 p-4 bg-[#FFD700]/10 rounded border border-[#FFD700]/20">
              <div className="text-sm">
                ...
                <span className="text-gray-600">
                  {" "}
                  Full CRUD interfaces for all 9 tables with forms, validation,
                  search, pagination, and role-based security (RLS) - all from
